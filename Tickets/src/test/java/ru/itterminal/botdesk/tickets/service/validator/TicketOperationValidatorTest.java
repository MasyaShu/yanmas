...
import static ru.itterminal.botdesk.tickets.service.validator.TicketOperationValidator.CURRENT_USER_WITH_ROLE_EXECUTOR_FROM_OUTER_GROUP_CAN_NOT_READ_TICKET_IF_TICKET_HAS_NOT_CURRENT_USER_AS_A_AUTHOR_AND_HAS_NOT_IN_EXECUTORS_AND_HAS_NOT_IN_OBSERVERS;
        ...
        return Stream.of(
                ...
                Arguments.of(
                        TestDataCrudTicketPermission
                                ...
                                .isTicketsExecutorContainsCurrentUser(false)
