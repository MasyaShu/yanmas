...
public class NotAllowedCreateFromCurrentUserIfTicketTypeIsNotPermitted implements EntityValidator<TicketSetting> {
    ...
    @Override
    public void checkAccessBeforeCreate(TicketSetting entity, User currentUser) {
