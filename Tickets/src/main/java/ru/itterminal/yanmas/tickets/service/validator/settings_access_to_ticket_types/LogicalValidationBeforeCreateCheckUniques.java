...
public class LogicalValidationBeforeCreateCheckUniques implements EntityValidator<SettingsAccessToTicketTypes> {

    private final SettingsAccessToTicketTypesRepository repository;

    @Override
    public void logicalValidationBeforeCreate(SettingsAccessToTicketTypes entity,
                                              Map<String, List<ValidationError>> errors) {
        var foundSetting = repository.findAllByAccount_IdAndGroup_IdAndUser_Id(
