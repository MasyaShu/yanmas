...
public class CheckUniquesBeforeCreateGroupTicketTypeValidator implements EntityValidator<GroupTicketTypes> {

    private final GroupTicketTypesRepository repository;

    @Override
    public void logicalValidationBeforeCreate(GroupTicketTypes entity, Map<String, List<ValidationError>> errors) {
