...
public class CheckUniquesBeforeCreateTicketSettingValidator implements EntityValidator<TicketSetting> {
    ...
    public void logicalValidationBeforeCreate(TicketSetting entity, Map<String, List<ValidationError>> errors) {
        ...
        var foundTicketSetting = repository.findAllByAccount_IdAndGroup_IdAndAuthor_Id(
