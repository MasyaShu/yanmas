...
import ru.itterminal.botdesk.tickets.model.dto.GroupTicketTypesDto;
...
public class GroupTicketTypesServiceImpl extends
        ...
        implements EntityConverter<GroupTicketTypes, GroupTicketTypesDto> {
...
//
    ...
    @Override
    public GroupTicketTypes convertRequestDtoIntoEntityWithNestedObjectsWithOnlyId(GroupTicketTypesDto request,
                                                                                   UUID accountId) {
        return null;
    }
