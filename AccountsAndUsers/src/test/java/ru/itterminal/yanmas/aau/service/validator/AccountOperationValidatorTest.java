...
import static ru.itterminal.yanmas.commons.service.validator.impl.BasicOperationValidatorImpl.*;
...
class AccountOperationValidatorTest {
    ...
    void checkUniqueness_shouldGetLogicalValidationException_whenEmailAlreadyExistInDatabase() {
        ...
        errors.put(AccountOperationValidator.EMAIL_OF_ACCOUNT_OWNER, singletonList(new ValidationError(NOT_UNIQUE_CODE,
        ...
        Assertions.assertEquals(logicalValidationException.getFieldErrors().get(AccountOperationValidator.EMAIL_OF_ACCOUNT_OWNER).get(0),
                thrown.getFieldErrors().get(AccountOperationValidator.EMAIL_OF_ACCOUNT_OWNER).get(0));
    }
