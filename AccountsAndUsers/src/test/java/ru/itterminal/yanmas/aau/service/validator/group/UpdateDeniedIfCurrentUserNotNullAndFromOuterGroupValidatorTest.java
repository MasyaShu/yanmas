...
import ru.itterminal.yanmas.aau.service.validator.group.check_access_before_create.UpdateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator;
...
@SpringJUnitConfig(value = {UpdateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator.class})
@Import(TestSecurityConfig.class)
@ActiveProfiles(SPRING_ACTIVE_PROFILE_FOR_UNIT_TESTS)
class UpdateDeniedIfCurrentUserNotNullAndFromOuterGroupValidatorTest {

    @Autowired
    UpdateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator updateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator;
    private final GroupTestHelper groupTestHelper = new GroupTestHelper();

    @Test
    @WithAnonymousUser
    void checkAccessBeforeCreate_shouldGetNoError_whenCurentUserIsNull() {
        Throwable throwable = catchThrowable(() -> updateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator
                .checkAccessBeforeCreate(null));
    ...
    void checkAccessBeforeCreate_shouldGetAccessDeniedException_whenCurrentUserByOuterGroup() {
        ...
        assertThrows(AccessDeniedException.class,
                () -> updateDeniedIfCurrentUserNotNullAndFromOuterGroupValidator
                        .checkAccessBeforeCreate(currentUser));
    }
