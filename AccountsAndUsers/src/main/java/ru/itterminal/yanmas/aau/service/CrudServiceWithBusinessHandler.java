...
public interface CrudServiceWithBusinessHandler<E extends BaseEntity> {
    ...
    E create(E entity, User currentUser);

    E update(E entity, User currentUser);
    ...
    Page<E> findAllByFilter(Specification<E> specification, Pageable pageable, User currentUser);
}
