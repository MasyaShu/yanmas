...
public class JwtProvider {
    ...
    public String createTokenWithJwtUser(String email, JwtUser jwtUser) {
        ...
        claims.put("authorities", jwtUser.getAuthorities().stream().findFirst().get().toString()); //NOSONAR
    ...
    @Deprecated
    public String createExpiredTokenWithUserEmail(String email, long milliseconds) { //NOSONAR
        chekStringForNullOrEmpty(email, EMAIL_IS_NULL, EMAIL_IS_EMPTY, JwtException.class, CANT_CREATE_TOKEN_BECAUSE);
